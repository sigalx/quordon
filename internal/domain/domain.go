...
const (
	...
	QueryShapesMediaTypeV1  = "application/json"
	QueryShapesMediaTypeV2  = "application/vnd.quordon.query-shapes.v2+json"
	QueryShapesMediaTypeV3  = "application/vnd.quordon.query-shapes.v3+json"
)

type AdapterFeature string

const FeatureTimeBucketUTC AdapterFeature = "time_bucket_utc"

func (f AdapterFeature) Valid() bool { return f == FeatureTimeBucketUTC }
